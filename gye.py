...
#-------------------------------------------------------------------------------
                        ...
                        for target in targets:
                            try:
                                ...
                                ki2.sendMessage(msg.to,"🔜Admin Berhasil Di Tambahkan")
                                break
                            except:
                        ...
                        for target in targets:
                            try:
                                ...
                                ki2.sendMessage(msg.to,"🔜Admin Berhasil Di hapus")
                                break
                            except:
...
#-------------------------------------------------------------------------------
                        ...
                        gye.sendMessage(msg.to,"anti js on")
...
#==============================================================================#
                        ...
                        ki2.sendMessage(msg.to,responsename2)
...
#-------------------------------------------------------------------------------
                        ...
                        ki2.sendMessage(msg.to,"🔜 Asist 2 ✔ Protect")
